...
/**
 * Потолок одного онлайн-доната, ₽ — зеркало `MAX_DONATION_KOPECKS` бэкенда.
 * Граница против опечатки и подбора, а не против щедрости: суммы такого
 * порядка в любом случае переводят по реквизитам.
 */
export const MAX_DONATION_RUBLES = 10_000_000;
